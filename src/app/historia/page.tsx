...
function HistoryPageInner() {
  ...
  }, [q, tag, from, to, fromMs, toMs, selectedMoods]);
  ...
  function pushFilters(next: {
    ...
    router.replace(`/historia${sp.toString() ? `?${sp}` : ""}`);
  }
            ...
            <section className="p-4 flex flex-col gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="h-8 px-3 rounded-full border border-border text-sm hover:bg-foreground/5"
                >
                  Dziś
                </button>
                <button
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {(from || to) && (
                  <button
                    type="button"
                    onClick={() => setRange("", "")}
                    className="ml-auto text-sm text-muted hover:text-foreground inline-flex items-center gap-1"
                  >
                  ...
                  {topTags.map((t) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className={
                            "text-xs " + (active ? "opacity-80" : "text-muted")
                          }
                        >
                          {t.count}
                        </span>
