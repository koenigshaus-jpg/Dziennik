// Publiczna dokumentacja REST API. Dostępna bez logowania.
// Server component — wykrywa stan logowania, żeby renderować InlineKeyPanel.
...
export default async function DocsPage() {
  ...
  return (
    <DocsLayout sections={NAV} isLoggedIn={isLoggedIn} activeTab="api">
      {/* INTRO */}
      <h1>REST API</h1>
      <p>
